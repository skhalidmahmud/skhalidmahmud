...
I am a passionate **Full-Stack Developer** and **Creative Designer** who loves building elegant solutions to complex problems. Currently, I'm focusing on backend systems and interactive web platforms.

- 🔭 **Currently working on**: [ThinkOri](https://github.com/skhalidmahmud) — A platform built with Django and Bootstrap.
- 🌱 **Learning**: Advanced Backend Architecture & Scalable Systems.
- 👯 **Looking to collaborate**: On Django-based open-source projects.
- 💬 **Ask me about**: Python, Django, Creative Design, or anything beyond logic.
- ⚡ **Fun fact**: You can't find me... unless I want to be found.
...
| :--- | :--- | :--- |
| **ThinkOri** | A modern tutoring/educational platform. | Django, Bootstrap, SQLite |
| **Credit System** | A reusable developer credit component for web projects. | JavaScript, HTML |
| **Portfolio** | This very profile and my personal showcase. | Markdown, CSS |
